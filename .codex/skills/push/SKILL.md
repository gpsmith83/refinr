...
2. Run local validation (`pnpm lint && pnpm test && pnpm build`) before pushing.
...
6. Write/update PR body with concrete content for this change.
  - If this repo has `.github/pull_request_template.md`, follow it.
  - If a PR already exists, refresh the body so it reflects the full scope.
